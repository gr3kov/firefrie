<?php $__env->startPush('styles'); ?>
	...
	<link href="<?php echo asset('./css/referal.css'); ?>" rel="stylesheet">
...
<?php $__env->startPush('scripts'); ?>
	...
	<script src="<?php echo asset('./js/referals.js'); ?>" type="text/javascript"></script>
<?php $__env->stopPush(); ?>
				...
				<div class="row1__col1 row__col">
					<div class="wrap">
						<div class="user-wrap">
							...
							<p class="user-id"><?php echo e($user->id); ?></p>
						</div>
				...
				<div class="row2__col1 row2__col row__col">
					<div class="row2__col__block1">
						...
						<div class="row2__col__text">
							...
							<p class="row2__col__value"><?php echo e($user->phone); ?></p>
						</div>
				...
				<div class="row2__col2 row2__col row__col">
					<div class="row2__col__block1">
						...
						<div class="row2__col__text">
							...
							<p class="row2__col__value"><?php echo e($user->email); ?></p>
						</div>
					...
					<div class="donutchart-wrapper">
						<div class="donutchart-heading">
							<p style="font-size: 22px">Мои игроки <span
									style="font-size: 14px"><span><?php echo e($user->all_partners_count); ?></span> всего</span></p><br><br>
							<div class="line-separator"></div>
						</div>
...
<?php echo $__env->make('layouts.auction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravelapp/resources/views/profile/referral.blade.php ENDPATH**/ ?>