<?php if($visibled): ?>
    <div class="form-group form-element-number <?php echo e($errors->has($name) ? 'has-error' : ''); ?>">
        ...
        <input v-pre <?php echo $attributes; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/laravelapp/vendor/laravelrus/sleepingowl/src/Providers/../../resources/views/default/form/element/number.blade.php ENDPATH**/ ?>