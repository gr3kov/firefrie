<div class="sidebar__info">
    <div class="sidebar__info-row">
        ...
        <div>
            ...
            <p class="grey-text">+994 50 789 46 75</p>
        </div>
    </div>
    <div class="sidebar__info-row">
        ...
        <div>
            ...
            <p class="grey-text">migom.inc@gmail.com</p>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/laravelapp/resources/views/partial/sidebarinfo.blade.php ENDPATH**/ ?>